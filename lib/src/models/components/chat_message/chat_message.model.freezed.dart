...
abstract class $ChatMessageModelCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String username, @DateTimeConvertor() DateTime time, String message});
}
...
class _$ChatMessageModelImpl implements _ChatMessageModel {
  const _$ChatMessageModelImpl(
      ...
      @DateTimeConvertor() required this.time,
  ...
  @override
  String toString() {
    return 'ChatMessageModel(username: $username, time: $time, message: $message)';
  }
...
abstract class _ChatMessageModel implements ChatMessageModel {
  const factory _ChatMessageModel(
      ...
      @DateTimeConvertor() required final DateTime time,
      required final String message}) = _$ChatMessageModelImpl;
