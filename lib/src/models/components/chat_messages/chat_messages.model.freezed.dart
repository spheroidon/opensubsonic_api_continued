...
abstract class $ChatMessagesModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<ChatMessageModel> chatMessage});
}
...
class _$ChatMessagesModelImpl implements _ChatMessagesModel {
  const _$ChatMessagesModelImpl(
      {final List<ChatMessageModel> chatMessage = const []})
  ...
  @override
  String toString() {
    return 'ChatMessagesModel(chatMessage: $chatMessage)';
  }
...
abstract class _ChatMessagesModel implements ChatMessagesModel {
  const factory _ChatMessagesModel({final List<ChatMessageModel> chatMessage}) =
